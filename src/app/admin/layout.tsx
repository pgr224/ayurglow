    ...
    <div className="flex min-h-screen bg-muted/30">
      ...
      <aside className="hidden md:flex w-64 flex-col fixed inset-y-0 z-50 bg-white border-r">
        <div className="h-16 flex items-center px-6 border-b">
          <Link href="/admin" className="text-xl font-black italic tracking-tighter text-primary">
            AAYURGLOW <span className="text-[10px] font-bold bg-primary text-white px-1 ml-1 rounded">ADMIN</span>
          </Link>
        </div>
        ...
        <div className="p-4 border-t">
           <Link href="/" className="flex items-center gap-3 px-4 py-2 text-sm font-bold text-red-500 hover:bg-red-50 rounded-lg transition-colors">
