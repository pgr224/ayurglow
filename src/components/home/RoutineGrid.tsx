...
const STEPS = [
  { id: 1, typeId: 'cleanser', name: 'CLEANSE', color: 'bg-[#F3E8FF]', text: 'text-purple-600', image: '/images/herbal-ubtan.jpg' },
  { id: 2, typeId: 'serum', name: 'CORRECT', color: 'bg-[#D1FAE5]', text: 'text-green-600', image: '/images/kumkumadi-oil.jpg' },
  { id: 3, typeId: 'moisturizer', name: 'MOISTURIZE', color: 'bg-[#DBEAFE]', text: 'text-blue-600', image: '/images/aloe-vera-gel.jpg' },
  { id: 4, typeId: 'haircare', name: 'HAIR CARE', color: 'bg-[#FEF3C7]', text: 'text-yellow-600', image: '/images/hair-mask-powder.jpg' }, // Adjusted step for the 4th product
]
    ...
    <section className="py-12 bg-white">
      <div className="container px-4">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 max-w-4xl mx-auto">
          {STEPS.map((step) => (
            <Link key={step.id} href={`/products?type=${step.typeId}`} className="group relative flex flex-col items-center gap-3">
